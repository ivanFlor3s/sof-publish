    ...
    ngOnInit() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!!this.config.textParams)
                Object.keys(this.config.textParams).forEach((key) => __awaiter(this, void 0, void 0, function* () { return this.config.textParams[key] = this.translateService.instant(this.config.textParams[key]); }));
            if (!!this.config.buttonsParams)
                Object.keys(this.config.buttonsParams).forEach((key) => __awaiter(this, void 0, void 0, function* () { return this.config.buttonsParams[key] = this.translateService.instant(this.config.buttonsParams[key]); }));
        });
    }
    onClick(type) {
...
class SofAlertService {
    ...
    show(config) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield firstValueFrom(this.dialog.open(AlertComponent, {
                data: config
            }).afterClosed());
        });
    }
    showConfirmAction(text, textParams, buttonsParams, width) {
        return __awaiter(this, void 0, void 0, function* () {
            const config = {
                ...
                width: width !== null && width !== void 0 ? width : '500px'
            };
            return yield firstValueFrom(this.dialog.open(AlertComponent, {
                maxWidth: '80vw',
                maxHeight: '80vh',
