...
import { lastValueFrom, Subscription, combineLatest, map } from 'rxjs';
...
import * as i1$6 from 'ag-grid-angular';
...
import * as i1$7 from '@sweetalert2/ngx-sweetalert2';
...
class DateRangePickerControlComponent extends BaseFormFieldComponent {
...
class DateRangePickerMaterialControlComponent extends DateRangePickerControlComponent {
}
...
DateRangePickerMaterialControlComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "13.1.3", type: DateRangePickerMaterialControlComponent, selector: "sof-date-range-picker-control", viewQueries: [{ propertyName: "errorControl", first: true, predicate: ErrorMaterialComponent, descendants: true }], usesInheritance: true, ngImport: i0, template: "<mat-label\r\n  [ngClass]=\"{\r\n    'required-label': isRequired,\r\n    'text-error': EsInvalido,\r\n    'active-label': inputRef1.focused || inputRef2.focused,\r\n    'no-label': noLabel,\r\n    'side-label': sideLabel\r\n  }\"\r\n  >{{ label }}</mat-label\r\n>\r\n\r\n<div class=\"input-container\" (click)=\"togglePicker(picker)\">\r\n  <mat-form-field\r\n    appearance=\"outline\"\r\n    [ngClass]=\"{ 'error-field': EsInvalido }\"\r\n  >\r\n    <mat-date-range-input [formGroup]=\"rangeForm\" [rangePicker]=\"picker\">\r\n      <input\r\n        autocomplete=\"off\"\r\n        matInput\r\n        #inputRef1=\"matInput\"\r\n        [readonly]=\"!editable\"\r\n        matStartDate\r\n        formControlName=\"start\"\r\n        [placeholder]=\"placeHolderFromDate\"\r\n        [readonly]=\"readOnly\"\r\n      />\r\n      <input\r\n        autocomplete=\"off\"\r\n        matInput\r\n        #inputRef2=\"matInput\"\r\n        [readonly]=\"!editable\"\r\n        matEndDate\r\n        formControlName=\"end\"\r\n        [placeholder]=\"placeHolderToDate\"\r\n        [readonly]=\"readOnly\"\r\n      />\r\n    </mat-date-range-input>\r\n    <mat-datepicker-toggle matSuffix [for]=\"picker\" [disabled]=\"disabled || readOnly\"></mat-datepicker-toggle>\r\n    <mat-date-range-picker #picker></mat-date-range-picker>\r\n  </mat-form-field>\r\n  <sof-error\r\n    [controlInvalido]=\"EsInvalido\"\r\n    [label]=\"label\"\r\n    [errors]=\"errors\"\r\n  ></sof-error>\r\n</div>\r\n", styles: ["@charset \"UTF-8\";:host{display:flex;flex-wrap:wrap;align-items:center}:host mat-label.active-label{color:#673ab7}:host mat-label.text-error{color:red}:host mat-label:not(.required-label):empty:after{content:\"\\a0\"}:host mat-label.required-label:after{content:\"*\";color:red}:host mat-label.no-label{display:none}:host mat-label.side-label{margin-right:30px}:host mat-label:not(.side-label){width:100%}:host .input-container{display:flex;flex-direction:column;flex-grow:1}:host mat-label{flex-grow:0}:host mat-label.side-label{margin-top:7px}:host *{align-self:center}:host mat-form-field{flex-grow:1}:host .input-container{width:100%}:host .input-container *{width:100%}.mat-input-element{margin-top:0!important}\n"], components: [{ type: i1$1.MatFormField, selector: "mat-form-field", inputs: ["color", "appearance", "hideRequiredMarker", "hintLabel", "floatLabel"], exportAs: ["matFormField"] }, { type: i2$3.MatDateRangeInput, selector: "mat-date-range-input", inputs: ["rangePicker", "required", "dateFilter", "min", "max", "disabled", "separator", "comparisonStart", "comparisonEnd"], exportAs: ["matDateRangeInput"] }, { type: i2$3.MatDatepickerToggle, selector: "mat-datepicker-toggle", inputs: ["for", "tabIndex", "aria-label", "disabled", "disableRipple"], exportAs: ["matDatepickerToggle"] }, { type: i2$3.MatDateRangePicker, selector: "mat-date-range-picker", exportAs: ["matDateRangePicker"] }, { type: ErrorMaterialComponent, selector: "sof-error" }], directives: [{ type: i1$1.MatLabel, selector: "mat-label" }, { type: i4.NgClass, selector: "[ngClass]", inputs: ["class", "ngClass"] }, { type: i1.NgControlStatusGroup, selector: "[formGroupName],[formArrayName],[ngModelGroup],[formGroup],form:not([ngNoForm]),[ngForm]" }, { type: i1.FormGroupDirective, selector: "[formGroup]", inputs: ["formGroup"], outputs: ["ngSubmit"], exportAs: ["ngForm"] }, { type: i4$1.MatInput, selector: "input[matInput], textarea[matInput], select[matNativeControl],      input[matNativeControl], textarea[matNativeControl]", inputs: ["disabled", "id", "placeholder", "name", "required", "type", "errorStateMatcher", "aria-describedby", "value", "readonly"], exportAs: ["matInput"] }, { type: i2$3.MatStartDate, selector: "input[matStartDate]", inputs: ["errorStateMatcher"], outputs: ["dateChange", "dateInput"] }, { type: i1.DefaultValueAccessor, selector: "input:not([type=checkbox])[formControlName],textarea[formControlName],input:not([type=checkbox])[formControl],textarea[formControl],input:not([type=checkbox])[ngModel],textarea[ngModel],[ngDefaultControl]" }, { type: i1.NgControlStatus, selector: "[formControlName],[ngModel],[formControl]" }, { type: i1.FormControlName, selector: "[formControlName]", inputs: ["formControlName", "disabled", "ngModel"], outputs: ["ngModelChange"] }, { type: i2$3.MatEndDate, selector: "input[matEndDate]", inputs: ["errorStateMatcher"], outputs: ["dateChange", "dateInput"] }, { type: i1$1.MatSuffix, selector: "[matSuffix]" }] });
...
class PrefixControlComponent extends BaseFormFieldComponent {
    onInput(value) {
        this.changeValue(value);
    }
}
PrefixControlComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: PrefixControlComponent, deps: null, target: i0.ɵɵFactoryTarget.Component });
PrefixControlComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "13.1.3", type: PrefixControlComponent, selector: "ng-component", inputs: { prefix: "prefix" }, usesInheritance: true, ngImport: i0, template: '', isInline: true });
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: PrefixControlComponent, decorators: [{
            type: Component,
            args: [{
                    template: '',
                }]
...
class PrefixControlMaterialComponent extends PrefixControlComponent {
    constructor() {
        super(...arguments);
...
MaterialControlsModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: MaterialControlsModule, declarations: [TextMaterialControlComponent,
        ...
        HttpClientModule,
        MatIconModule,
        MatChipsModule, i5.NgxMaskModule, ReactiveFormsModule], exports: [TextMaterialControlComponent,
        TextAreaMaterialControlComponent,
        DateRangePickerMaterialControlComponent,
        NumberMaterialControlComponent,
        CheckboxMaterialControlComponent,
...
class FormularioService {
    ...
    procesarPrefix(form, field) {
        ...
        if (!field.prefixConfig ||
            !((_a = field.prefixConfig) === null || _a === void 0 ? void 0 : _a.prefixDinamic) ||
            ((_b = field.prefixConfig) === null || _b === void 0 ? void 0 : _b.prefixDinamic.controlKeyDependencies.length) == 0) {
            return;
        }
        const controlDependencies = (_c = field.prefixConfig.prefixDinamic) === null || _c === void 0 ? void 0 : _c.controlKeyDependencies.map((control) => {
            var _a;
            if (!!!form.get(control)) {
                throw new Error('[Dinamyx prefix] no existe el control ' + control);
            }
            return (_a = form.get(control)) === null || _a === void 0 ? void 0 : _a.valueChanges;
        });
        const prefixDependencies$ = combineLatest(controlDependencies).pipe(map((r) => {
            var _a, _b;
            if (r.every((x) => !!x)) {
                return (_b = (_a = field.prefixConfig) === null || _a === void 0 ? void 0 : _a.prefixDinamic) === null || _b === void 0 ? void 0 : _b.reduceFn(r.map((x) => x.toString()));
            }
            else
                return '';
        }));
...
PaginationComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "13.1.3", type: PaginationComponent, selector: "app-pagination", inputs: { TotalItems: "TotalItems", PageSize: "PageSize" }, outputs: { pageChangeEvent: "pageChangeEvent" }, ngImport: i0, template: "<mat-paginator [length]=\"TotalItems\"\r\n               [pageSize]=\"PageSize\"\r\n               [pageSizeOptions]=\"[5,10,15,20]\"\r\n               (page)=\"onChange($event)\"\r\n               [showFirstLastButtons]=\"true\"\r\n               aria-label=\"Select page\">\r\n</mat-paginator>\r\n", styles: [""], components: [{ type: i1$5.MatPaginator, selector: "mat-paginator", inputs: ["disabled"], exportAs: ["matPaginator"] }], encapsulation: i0.ViewEncapsulation.None });
...
class LuxonDateTimeRendererComponent {
    ...
    setCellValue(params) {
        ...
        if (!params.value)
            this.cellValue = '';
        else if (!!(config === null || config === void 0 ? void 0 : config.toFormat))
...
GridControlModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: GridControlModule, declarations: [GridControlComponent,
        ...
        MatIconModule, i1$6.AgGridModule, MatButtonModule,
        MatMenuModule,
        MatInputModule,
        MatTooltipModule,
...
class AlertService {
    ...
    showConfirmWithInputHtml(title, text, icon, confirmButtonText, cancelButtonText, html, preConfirm, input, inputLabel, inputPlaceholder, inputOptions, inputAttributes, inputValidator, inputValue) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.swalWithMatButtonsConfirm.fire({
                title,
                text,
...
AlertModule.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "13.1.3", ngImport: i0, type: AlertModule, imports: [i1$7.SweetAlert2Module] });
...
export { AG_GRID_LOCALE_EN, AG_GRID_LOCALE_ES, ActionFormTypes, AlertModule, AlertService, AutocompleteMaterialControlComponent, BadgeComponent, BaseFormFieldComponent, CardComponent, CheckboxGroupMaterialControlComponent, CheckboxMaterialControlComponent, ControlsComponent, ControlsModule, ControlsService, CustomClassSweet, DataValidators, DatePickerMaterialControlComponent, DateRangePickerMaterialControlComponent, DateTimeValidators, DenseTextMaterialControlComponent, DocControlComponent, DynFormComponent, DynamicFormModule, ErrorMaterialComponent, ErrorsConfigurations, FileUploadMaterialControlComponent, FileValidators, FormConfigTypes, FormularioService, GridControlComponent, GridControlModule, GridHandlerService, LinkSweet, LuxonDateTimeRendererComponent, MaterialControlsModule, NumberMaterialControlComponent, NumberValidators, PageSizeComponent, PasswordMaterialControlComponent, PhoneMaterialControlComponent, PrefixControlMaterialComponent, RadioButtonMaterialControlComponent, RequiredValidators, RowOptionsComponent, SearchBoxMaterialControlComponent, SelectMaterialControlComponent, TextAreaMaterialControlComponent, TextMaterialControlComponent, TextValidators, TimePickerMaterialControlComponent, ValidationTypes, ValidationsModule, defaultErrorMessages };
